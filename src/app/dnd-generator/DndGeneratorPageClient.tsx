...
export function DndGeneratorPageClient() {
  const { t } = useLanguage();
  ...
  const webAppJsonLd = {
    ...
    description:
      "Free DnD image generator powered by AI. Create epic Dungeons & Dragons scenes, characters, battle maps, and fantasy art. Generate D&D images for your campaigns.",
    url: `${baseUrl}/dnd-generator`,
  ...
  const breadcrumbJsonLd = generateBreadcrumbList([
    ...
    { name: "AI Game Tools", url: `${baseUrl}/game-tools` },
    { name: "DnD Image Generator", url: `${baseUrl}/dnd-generator` },
  ]);
