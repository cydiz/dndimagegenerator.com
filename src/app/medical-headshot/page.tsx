...
export default function MedicalHeadshotPage() {
  ...
  return (
    <ToolPageLayout
      ...
      subtitle="Professional medical portraits"
      description="Create professional headshots for doctors, nurses, and medical professionals. Perfect for hospital websites, directories, and credentials."
      badge="AI Headshot"
    >
          ...
          <div className="space-y-4">
            <div className="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50 p-8">
              <input
                ...
                className="hidden"
                id="medical-headshot-upload"
              />
              <label
                htmlFor="medical-headshot-upload"
        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-sm shadow-slate-100">
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              <li>• Hospital websites</li>
              <li>• Medical directories</li>
              <li>• Professional credentials</li>
              <li>• Clinic profiles</li>
              <li>• Medical publications</li>
            </ul>
          </div>
        </div>
      </div>
